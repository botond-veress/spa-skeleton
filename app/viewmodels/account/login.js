define(['managers/navigationManager', 'managers/notificationManager', 'models/account/loginAccount'],
    function (navigationManager, notificationManager, loginAccount) {
        ...
        function submit() {
            ...
            return navigationManager.authenticate(entity.serialize(), entity().remember.value(), redirect)
                .fail(function (data) {
                    notificationManager.failure(data.error);
                })
                .always(function () {
